export const en = {
  ...
  'error.spotifyAuthExpired': 'Your Spotify session expired. Reconnect your account; current page data will stay in place.',
  'error.spotifyAuthStateMismatch': 'Spotify login verification failed. Please try again.',
